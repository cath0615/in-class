...
let third = _.nth(myArray, 2);
let chunky = _.chunk(myArray, 2); // chunk array into set of the input number
let slicey = _.slice(myArray, 2, -3); // extract the given index element from array
let rando = _.random(60);
let sammy = _.sample(myArray);// random element from array
let shuff = _.shuffle(myArray); // change the order of the array
