...
class Puppy {
    ...
    constructor(
        img = "https://www.akcpetinsurance.com/res/akc/blog/2020/three-common-puppy-illnesses/akc-pupill-hdr.jpg",
        sound = "WOOF!") {
        this.img = img;
        this.sound = sound;
    }
...
let app = new PuppyApp(
    $(`#content`),
    [{
        url: "https://w3i7z3h8.stackpathcdn.com/wp-content/uploads/2020/07/Training-Time-Aug2020-GR-with-ball-scaled.jpg",
        sound: "bark"
    }]
)
